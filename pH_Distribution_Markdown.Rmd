...
This R Markdown file details creating a distribution plot using ggplot2 from a csv file. In particular, this script focuses on the environmental pH distribution of various soil samples. For more information on basic density charts with ggplot2, reference the following link: 
\
